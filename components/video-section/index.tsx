      ...
      <div className="container">
        <div className={styles.inner}>
          ...
          <div className={styles.embedWrap} data-reveal data-delay="1">
            <video
              src="https://earasers-eu.myshopify.com/cdn/shop/videos/c/vp/4bb8851a65cc46aa983fe2a5ea8e5561/4bb8851a65cc46aa983fe2a5ea8e5561.HD-1080p-7.2Mbps-15810489.mp4"
              controls
              playsInline
              preload="metadata"
