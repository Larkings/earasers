            ...
            <div className={styles.inner}>
              ...
              <section className={styles.section}>
                ...
                <p>
                  ...
                  responsible for the sale and distribution of Earasers earplugs in the European market.
                </p>
              ...
              <section className={styles.section}>
                <p className={styles.sectionLabel}>02 — Orders and pricing</p>
              ...
              <section className={styles.section}>
                <p className={styles.sectionLabel}>03 — Payment</p>
                <h2>Payment</h2>
                <p>
              ...
              <section className={styles.section}>
                <p className={styles.sectionLabel}>04 — Shipping and delivery</p>
              ...
              <section className={styles.section}>
                <p className={styles.sectionLabel}>05 — Right of withdrawal</p>
                <h2>Right of withdrawal (EU cooling-off period)</h2>
                <p>
              ...
              <section className={styles.section}>
                <p className={styles.sectionLabel}>06 — Size exchange</p>
                <h2>Size exchange guarantee</h2>
                <p>
              ...
              <section className={styles.section}>
                <p className={styles.sectionLabel}>07 — Warranty</p>
                <h2>Warranty and defects</h2>
                <p>
              ...
              <section className={styles.section}>
                <p className={styles.sectionLabel}>08 — Intellectual property</p>
              ...
              <section className={styles.section}>
                <p className={styles.sectionLabel}>09 — Liability</p>
                <h2>Liability</h2>
                <p>
              ...
              <section className={styles.section}>
                <p className={styles.sectionLabel}>10 — Complaints</p>
                <h2>Complaints</h2>
                <p>
              ...
              <section className={styles.section}>
                <p className={styles.sectionLabel}>11 — Governing law</p>
                <h2>Governing law</h2>
                <p>
              ...
              <section className={styles.section}>
                <p className={styles.sectionLabel}>12 — Updates</p>
