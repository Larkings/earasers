        ...
        <div className="container">
          <div className={styles.content}>
            ...
            <section className={styles.section}>
              <h2>1. Who we are</h2>
              <p>
                This website is operated by <strong>Earasers Europe</strong>, responsible for the sale and
                distribution of Earasers earplugs in the European market.
              </p>
              <p>
            ...
            <section className={styles.section}>
              ...
              <p>
                You can disable non-essential cookies in your browser settings at any time. This will not
                affect your ability to browse the site or complete a purchase.
              </p>
            </section>
